...
const MOCK_CHAMPION_DETAILS: Record<string, ChampionDraftInfo> = {
  Orianna:      { name: 'Orianna',      class: 'Mage',     scaling: 'Mid',   tags: ['Poke', 'Waveclear', 'Peel'], meta_tier: 'A' },
  Azir:         { name: 'Azir',         class: 'Mage',     scaling: 'Late',  tags: ['Poke', 'Waveclear', 'Engage'], meta_tier: 'S' },
  Ahri:         { name: 'Ahri',         class: 'Mage',     scaling: 'Mid',   tags: ['Burst', 'Poke'], meta_tier: 'B' },
  Syndra:       { name: 'Syndra',       class: 'Mage',     scaling: 'Mid',   tags: ['Burst', 'Poke'], meta_tier: 'A' },
  Zed:          { name: 'Zed',          class: 'Assassin', scaling: 'Mid',   tags: ['Burst', 'Splitpush'], meta_tier: 'B' },
  Malphite:     { name: 'Malphite',     class: 'Tank',     scaling: 'Mid',   tags: ['Engage', 'Knockup'], meta_tier: 'B' },
  Ornn:         { name: 'Ornn',         class: 'Tank',     scaling: 'Late',  tags: ['Engage', 'Knockup', 'Peel'], meta_tier: 'S' },
  Gnar:         { name: 'Gnar',         class: 'Fighter',  scaling: 'Mid',   tags: ['Engage', 'Knockup', 'Splitpush'], meta_tier: 'A' },
  Fiora:        { name: 'Fiora',        class: 'Fighter',  scaling: 'Late',  tags: ['Splitpush', 'Sustain'], meta_tier: 'B' },
  Jayce:        { name: 'Jayce',        class: 'Fighter',  scaling: 'Early', tags: ['Poke', 'Burst'], meta_tier: 'B' },
  'Lee Sin':    { name: 'Lee Sin',      class: 'Fighter',  scaling: 'Early', tags: ['Engage', 'Burst'], meta_tier: 'A' },
  Viego:        { name: 'Viego',        class: 'Assassin', scaling: 'Mid',   tags: ['Sustain', 'Burst'], meta_tier: 'S' },
  'Jarvan IV':  { name: 'Jarvan IV',    class: 'Fighter',  scaling: 'Early', tags: ['Engage', 'Knockup'], meta_tier: 'B' },
  Jinx:         { name: 'Jinx',         class: 'Marksman', scaling: 'Late',  tags: ['Waveclear', 'Burst'], meta_tier: 'A' },
  "Kai'Sa":     { name: "Kai'Sa",       class: 'Marksman', scaling: 'Mid',   tags: ['Burst', 'Engage'], meta_tier: 'S' },
  Ezreal:       { name: 'Ezreal',       class: 'Marksman', scaling: 'Mid',   tags: ['Poke', 'Burst'], meta_tier: 'A' },
  Aphelios:     { name: 'Aphelios',     class: 'Marksman', scaling: 'Late',  tags: ['Burst', 'Waveclear'], meta_tier: 'B' },
  Thresh:       { name: 'Thresh',       class: 'Support',  scaling: 'Early', tags: ['Engage', 'Peel'], meta_tier: 'A' },
  Nautilus:     { name: 'Nautilus',     class: 'Support',  scaling: 'Early', tags: ['Engage', 'Knockup'], meta_tier: 'B' },
  Lulu:         { name: 'Lulu',         class: 'Support',  scaling: 'Mid',   tags: ['Peel', 'Sustain'], meta_tier: 'A' },
};
